...
<div id="container" style="margin:0 auto;width:90%">
    ...
    <br/>
    <span id="web_type" style="display:none">Edit</span>
...
?>
		 ...
		 ?> 
            ...
            <tr>
                <td>
                    <br/>
                    <?php
                    echo $this->Form->button('&nbsp;บันทึกข้อมูลผู้สำรวจ&nbsp;', array('type' => 'button', 'id' => 'btnSaveOfficer'));
                    ?>
                </td>
            </tr>
            <tr>
                <td>&nbsp;
                <?php
                echo $this->Form->input('officer_id',array('type'=>'hidden'));
                        ...
                        <tr>
                            ...
                            <td>
								...
								<?php
	                                ...
	                                $tmp = $ary_tambol;
	                                //echo $tmp;
	                                echo $this->Form->input('tambol_id', array(
	                                    'options'=>$tmp,
	                                     'label' => false,
	                                     'default' => $tmp_default,
	                                     'div' => false,
    ...
    <div id="tab-3" class="ui-tabs-panel ui-tabs-hide">
     <h3><?php echo $header_title; ?></h3>
     <span id="cur_tab3" style="display:none">3</span>
        <b>สมาชิกในครอบครัวที่อาศัยอยู่ร่วมกันจริงในปัจจุบันมีทั้งหมด</b>&nbsp;<span id="lbl_total_member"><?php echo $count_member; ?></span>&nbsp;<b>คน</b>
     ...
     for ($i=1; $i <= $count_member ; $i++) { 
      # code...
     ?>
     <div id="member_<?php echo $i; ?>">
     <?php
      echo $this->Form->create('Formtab3'.$i);
     ?>
  <table width="100%" cellpadding="5" cellspacing="8" border="0">
  <tr>
      <td valign="top">
   <!-- Begin row -->
   <b>สมาชิกลำดับที่ &nbsp;<span id="member_no"><?php echo $i; ?></span></b><br/>
   <table width="100%" cellpadding="0" cellspacing="0" border="0">
       <tr>
    <td align="right">
        คำนำหน้าชื่อ :   &nbsp;                  
  ...
  ?>
     ...
     <?php
      echo $this->Form->button('&nbsp;บันทึกข้อมูล&nbsp;', array('type' => 'button', 'id' => 'btnSave_tab3'));
     ?>
     <br><br>
    </div>
